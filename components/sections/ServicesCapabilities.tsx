...
const capabilities = [
  {
    ...
    value: 95,
    description:
      "Conception de systèmes automatisés pour améliorer la productivité industrielle et réduire les erreurs humaines.",
  },
  {
    title: "Structures métalliques",
    value: 90,
    description:
      "Fabrication de structures métalliques robustes adaptées aux infrastructures modernes et industrielles.",
  },
  {
    title: "Ascenseurs intelligents",
    value: 88,
    description:
      "Systèmes d’élévation intelligents intégrant sécurité, automatisation et monitoring avancé.",
  },
  {
    title: "Domotique avancée",
    value: 92,
    description:
      "Intégration de technologies smart building pour le contrôle intelligent des infrastructures.",
  },
];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className={`${isDark ? "text-gray-400" : "text-gray-600"} max-w-2xl mx-auto text-lg`}>
            Notre expertise combine ingénierie mécanique, automatisation et
            technologies intelligentes pour construire les infrastructures
            de demain.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          {capabilities.map((cap, index) => (
            ...
            >
              ...
              {/* BARRE DE CAPACITÉ AVEC ANIMATION AU SCROLL */}
