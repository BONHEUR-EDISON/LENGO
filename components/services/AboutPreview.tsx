    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          ...
          className={`absolute -top-40 -left-40 w-[500px] h-[500px] blur-[160px] rounded-full ${isDark ? "bg-blue-500/20" : "bg-blue-300/20"}`}
        />
        <motion.div
          animate={{ x: [0, -100, 60, 0], y: [0, 80, -40, 0] }}
          transition={{ duration: 20, repeat: Infinity }}
          className={`absolute bottom-[-250px] right-[-250px] w-[650px] h-[650px] blur-[180px] rounded-full ${isDark ? "bg-purple-600/20" : "bg-purple-400/20"}`}
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
            Engineering the Future <br /> of Smart Infrastructure
          </h2>

          <p className={`${isDark ? "text-gray-300" : "text-gray-600"} text-lg max-w-xl mx-auto lg:mx-0`}>
            Des solutions intelligentes et connectées pour la construction métallique, l’automatisation industrielle, la domotique et les infrastructures urbaines de demain.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <a
              href="#services"
              className={`inline-flex items-center gap-3 px-8 py-4 rounded-full border ${isDark ? "border-white/20" : "border-gray-300"} hover:bg-black/5 dark:hover:bg-white/5 transition`}
            >
        ...
        >
          <motion.div
            ...
            className={`p-8 rounded-3xl backdrop-blur-xl shadow-xl ${isDark ? "bg-white/5 border-white/10" : "bg-white/70 border-gray-200"}`}
          >
            <span className="text-sm font-semibold text-red-500">Challenge</span>
            <p className={`${isDark ? "text-gray-300" : "text-gray-600"} mt-4`}>
              Les infrastructures modernes exigent automatisation, intelligence et performance pour l’industrie et les villes connectées.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className={`${isDark ? "text-gray-300" : "text-gray-600"} mt-4`}>
              Nous combinons structures métalliques, automatisation industrielle et technologies intelligentes pour créer des solutions fiables, performantes et durables.
            </p>
          </motion.div>
        </motion.div>
      </div>
